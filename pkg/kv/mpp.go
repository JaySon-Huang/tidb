...
type MPPClient interface {
	...
	ConstructMPPTasks(context.Context, *MPPBuildTasksRequest, time.Duration, tiflashcompute.DispatchPolicy, string, tiflash.ReplicaRead, func(error)) ([]MPPTaskMeta, error)
